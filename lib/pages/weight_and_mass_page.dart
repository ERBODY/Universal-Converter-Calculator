...
class WeightAndMassPage extends StatefulWidget {
  final String currentLanguage;
  const WeightAndMassPage({super.key, required this.currentLanguage});

  @override
  _WeightAndMassPageState createState() => _WeightAndMassPageState();
}

class _WeightAndMassPageState extends State<WeightAndMassPage> {
  ...
  final Map<String, double> _conversionFactors = {
    ...
    'Grams (g)': 1,
    'Kilograms (kg)': 1000,
    'Metric Tonnes (t)': 1000000,
    'Ounces (oz)': 28.3495,
    'Pounds (lb)': 453.592,
    'Stone (st)': 6350.29,
    'US Tons': 907185,
    'Imperial Tons': 1016047,
  };
  ...
  void _convertUnits() {
    ...
    setState(() {
      final inGrams = inputValue * _conversionFactors[_fromUnit]!;
      _convertedValue = inGrams / _conversionFactors[_toUnit]!;
      _hasCalculated = true;
    });
  }
      ...
      appBar: AppBar(
        title: Text(
          Translations.getTranslation(
              widget.currentLanguage, 'weight_and_mass_unit'),
        ),
        actions: [
          IconButton(
